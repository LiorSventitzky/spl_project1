...
int main(int argc, char **argv)
{
    ...
    */
    ...
    AddCustomer *ac1 = new AddCustomer("a", "solider", 2, 3);
    ac1->act(wareHouse);
    AddCustomer *ac2 = new AddCustomer("b", "solider", 10, 2);
    ac2->act(wareHouse);
    AddCustomer *ac3 = new AddCustomer("c", "civilian", 5, 5);
    ac3->act(wareHouse);
    AddCustomer *ac4 = new AddCustomer("d", "solider", 6, 3);
    ac4->act(wareHouse);
    ...
    wareHouse.PrintStuff();
    std::cout << std::to_string(wareHouse.getOrderCounter()) << std::endl;
